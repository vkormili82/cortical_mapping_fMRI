...
if __name__ == "__main__":
    ...
    tomograph = convert('tomograph_2.m4a')
    ...
    while os.path.isfile(f'C:/Users/Admin/PycharmProjects/corticalmapping_fMRI/fragments/segment_{i}.wav'):
        line = rec.transcription(
            f'C:/Users/Admin/PycharmProjects/corticalmapping_fMRI/fragments/segment_{i}.wav')
